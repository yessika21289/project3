        ...
        <form class="form-horizontal" id="selling-header" method="post" action="<?php echo base_url();?>selling/saveSelling">
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="date" class="form-control" name="faktur-date" id="faktur-date" value="<?php echo ($selling[0]['date_faktur']) ? date('Y-m-d',$selling[0]['date_faktur']) : date('Y-m-d');?>" required/>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="spj-no" id="spj-no" value="<?php echo $selling[0]['no_spj'];?>" />
              </div>
            </div>
            <div class="form-group">
          ...
          <fieldset>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="grand-discount" id="grand-discount" value="<?php echo $selling[0]['discount'];?>" />
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <input type="number" min="0" class="form-control" name="dp" id="dp" value="<?php echo $selling[0]['dp'];?>" />
              </div>
            </div>
            <div class="form-group">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div class="col-sm-9">
              ...
              <input type="text" class="form-control" name="product-name" id="product-name" readonly required />
            </div>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#product-list-modal" data-backdrop="static" data-keyboard="false">+</button>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-4">
              <input type="number" min="0" class="form-control" name="sell-price" id="sell-price" autocomplete="off" required />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="discount-1">D.1.(%):</label>
            <div class="col-sm-2">
              <input type="number" min="0" max="100" class="form-control" name="discount-1" id="discount-1" />
            </div>
            <label class="control-label col-sm-1" for="discount-2">D.2.(%):</label>
            <div class="col-sm-2">
              <input type="number" min="0" max="100" class="form-control" name="discount-2" id="discount-2" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-sm-2" for="discount-3">Potongan (Rp):</label>
            <div class="col-sm-2">
              <input type="number" min="0" class="form-control" name="discount-3" id="discount-3" />
            </div>
            <label class="control-label col-sm-1" for="ppn">PPn(%):</label>
            <div class="col-sm-2">
              <input type="number" min="0" max="100" class="form-control" name="ppn" id="ppn" />
            </div>
          </div>
          <div class="form-group">
